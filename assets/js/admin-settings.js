...
(function () {
  ...
  const fields = {
    ...
    sponsor_mf_preroll_status: form.querySelector('[name="sponsor_mf_preroll_status"]'),
    sponsor_mf_preroll_until: form.querySelector('[name="sponsor_mf_preroll_until"]'),
    sponsor_mf_midroll_status: form.querySelector('[name="sponsor_mf_midroll_status"]'),
    sponsor_mf_midroll_until: form.querySelector('[name="sponsor_mf_midroll_until"]'),
    ...
    sponsor_crc_preroll_status: form.querySelector('[name="sponsor_crc_preroll_status"]'),
    sponsor_crc_preroll_until: form.querySelector('[name="sponsor_crc_preroll_until"]'),
    sponsor_crc_midroll_status: form.querySelector('[name="sponsor_crc_midroll_status"]'),
    sponsor_crc_midroll_until: form.querySelector('[name="sponsor_crc_midroll_until"]'),
