...
(function () {
  ...
  const fields = {
    ...
    sponsor_nl_top_status: form.querySelector('[name="sponsor_nl_top_status"]'),
    sponsor_nl_top_until: form.querySelector('[name="sponsor_nl_top_until"]'),
    sponsor_nl_bottom_status: form.querySelector('[name="sponsor_nl_bottom_status"]'),
    sponsor_nl_bottom_until: form.querySelector('[name="sponsor_nl_bottom_until"]'),
    sponsor_mf_preroll1_status: form.querySelector('[name="sponsor_mf_preroll1_status"]'),
    sponsor_mf_preroll1_until: form.querySelector('[name="sponsor_mf_preroll1_until"]'),
    sponsor_mf_preroll2_status: form.querySelector('[name="sponsor_mf_preroll2_status"]'),
    sponsor_mf_preroll2_until: form.querySelector('[name="sponsor_mf_preroll2_until"]'),
    sponsor_mf_midroll1_status: form.querySelector('[name="sponsor_mf_midroll1_status"]'),
    sponsor_mf_midroll1_until: form.querySelector('[name="sponsor_mf_midroll1_until"]'),
    sponsor_mf_midroll2_status: form.querySelector('[name="sponsor_mf_midroll2_status"]'),
    sponsor_mf_midroll2_until: form.querySelector('[name="sponsor_mf_midroll2_until"]'),
    sponsor_mf_postroll_status: form.querySelector('[name="sponsor_mf_postroll_status"]'),
    sponsor_mf_postroll_until: form.querySelector('[name="sponsor_mf_postroll_until"]'),
    sponsor_crc_preroll1_status: form.querySelector('[name="sponsor_crc_preroll1_status"]'),
    sponsor_crc_preroll1_until: form.querySelector('[name="sponsor_crc_preroll1_until"]'),
    sponsor_crc_preroll2_status: form.querySelector('[name="sponsor_crc_preroll2_status"]'),
    sponsor_crc_preroll2_until: form.querySelector('[name="sponsor_crc_preroll2_until"]'),
    sponsor_crc_midroll1_status: form.querySelector('[name="sponsor_crc_midroll1_status"]'),
    sponsor_crc_midroll1_until: form.querySelector('[name="sponsor_crc_midroll1_until"]'),
    sponsor_crc_midroll2_status: form.querySelector('[name="sponsor_crc_midroll2_status"]'),
    sponsor_crc_midroll2_until: form.querySelector('[name="sponsor_crc_midroll2_until"]'),
    sponsor_crc_postroll_status: form.querySelector('[name="sponsor_crc_postroll_status"]'),
