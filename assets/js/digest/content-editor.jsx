                ...
                {(() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <div style={{ fontSize: 13, fontWeight: 600, color: '#2d2927', lineHeight: 1.2 }}>No signature</div>
                        <div style={{ fontSize: 10, color: '#9a8773', marginTop: 2, lineHeight: 1.2 }}>Omit sign-off</div>
                      </div>
                    </button>
                  );
                })()}
