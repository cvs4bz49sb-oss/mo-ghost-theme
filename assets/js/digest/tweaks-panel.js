...
`;
  const __TWEAKS_PARENT_ORIGIN = {
    value: typeof window !== "undefined" && window.location && window.location.ancestorOrigins && window.location.ancestorOrigins[0] || typeof window !== "undefined" && window.location && window.location.origin || null,
    capture(origin) {
  ...
  function TweakSection({ label, title, children }) {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "twk-sect" }, title || label), children);
  }
